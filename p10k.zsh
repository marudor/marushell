# Generated by Powerlevel10k configuration wizard on 2020-07-02 at 16:12 CEST.
...
() {
  ...
  typeset -g _POWERLEVEL9K_KUBECONTEXT_SHOW_DEFAULT_NAMESPACE=0
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/marudor}'
