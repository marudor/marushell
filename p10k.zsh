# Generated by Powerlevel10k configuration wizard on 2021-08-03 at 01:08 CEST.
...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${${${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/marudor}:#/do-services-titan-build}:#/do-services-titan-prod}'
